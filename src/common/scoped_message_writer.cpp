...
#define GUUS_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/guus_integration_test_hooks.h"

// NOTE(guus): This file only exists because I need a way to hook into the
...
// guus_integration_test_hooks.h functions which isn't possible to expose in
