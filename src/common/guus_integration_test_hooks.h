...
#ifndef GUUS_INTEGRATION_TEST_HOOKS_H
#define GUUS_INTEGRATION_TEST_HOOKS_H
...
#endif // GUUS_INTEGRATION_TEST_HOOKS_H
...
//
// -------------------------------------------------------------------------------------------------
#ifdef GUUS_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include <string.h>
#include <assert.h>
#include <sys/stat.h>
#include <fcntl.h>
...
#endif // GUUS_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
